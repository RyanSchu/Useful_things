...
parser$add_argument("--data", help="path to the db file")
parser$add_argument("--match", help="path to lifted bed file, also containing corrected cpos and VarIDs as its last two column")
